...
from backpack import backpack, extend
from backpack.extensions import HMP, DiagHessian
from training_loop import train_val_loop, train_val_loop_v2
...
with open(log_filename,"a") as f:
    ...
    if not bn:
        print(f"Batch norm is not used", file=f)
    else:
        print(f"Batch norm is used", file=f)
prune_count = 0
sparsity = 0.0
one_update = True
bias_prune = False
