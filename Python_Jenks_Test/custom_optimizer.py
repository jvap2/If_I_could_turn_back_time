...
#             if 'last_weights' not in self.state:
#                 self.state['last_weights'] = self.state['params']
#             last_weights = self.state['last_weights']
...
#                         # Update parameters
#                         param_data_flat[indices] = last_weights[indices] - lr * velocity_flat[indices]
#                         param_data_flat[indices_] = 0
#                         param.data = param_data_flat.view(param.data.shape)
#                     else:
#                         pass
#                 else:  # Assuming bias vectors have 1 dimension
